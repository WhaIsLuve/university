...
namespace UI.ChangeData
{
	...
	{
		private readonly string _genreOldName;
		private readonly IGenreRepository _genreRepository;

		public ChangeGenreForm(string oldName)
		{
			InitializeComponent();
			Name.Text = oldName;
			_genreOldName = oldName;
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			var result = _genreRepository.Update(_genreOldName, new Genre(Name.Text));
			if (result.IsSuccess)
			{
				Close();
				return;
